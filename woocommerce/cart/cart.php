				...
				<div>
					...
					<div>
						<div colspan="6" class="actions">
							...
							<div class="cart-top-buttons" style="display:flex;gap:10px;margin-bottom:15px;">
...
if ( $similar_products->have_posts() ) : ?>
    <div class="cart-similar-products">
       ...
       <ul class="products">
    <?php while ( $similar_products->have_posts() ) : $similar_products->the_post(); global $product; ?>
