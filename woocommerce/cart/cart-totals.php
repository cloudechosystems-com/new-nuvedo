	...
	<div cellspacing="0" class="shop_table shop_table_responsive">
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<div class="cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				<div class="discount_coupn_label">Discount</div>
				<div class="discount_coupn_amount" data-title="<?php echo esc_attr( wc_cart_totals_coupon_label( $coupon, false ) ); ?>"><?php wc_cart_totals_coupon_html( $coupon ); ?></div>
			</div>
		<?php endforeach; ?>
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<div class="fee">
				...
				<div data-title="<?php echo esc_attr( $fee->name ); ?>"><?php wc_cart_totals_fee_html( $fee ); ?></td>
			</div>
		<?php endforeach; ?>
		...
		<div class="order-total">
			<div><?php esc_html_e( 'Grand Total', 'woocommerce' ); ?><br><?php esc_html_e( 'You Saved', 'woocommerce' ); ?></div>
