...
<div class="u-columns col2-set" id="customer_login">
	<div class="tab_button">
	 <div class="reg_form_button active" id="sign_in_">
		 <h2><?php esc_html_e( 'SIGN IN', 'woocommerce' ); ?></h2>
		 </div>
	 <div class="reg_form_button" id="sign_up_">
		 <h2><?php esc_html_e( 'SIGN UP', 'woocommerce' ); ?></h2>
	 </div>
 </div>
	<div class="reg_content" id="sign_in_content">
<?php endif; ?>
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			<?php do_action( 'woocommerce_login_form_start' ); ?>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<!-- <label for="username"><?php esc_html_e( 'Username or email address', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label> -->
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" placeholder="Email Address" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
	...
	<div class="reg_content hidden" id="sign_up_content">
